...
const Footer = () => {
  ...
  <h2 className="text-xl font-bold">Tharushi S S</h2>
  <p className="text-sm mt-1 text-gray-200">tharushibabu@ieee.org</p>
  <div className="flex items-center justify-center gap-2 mt-1 text-gray-200">
    
    <span>📞 7358638595</span>
  </div>
</div>
